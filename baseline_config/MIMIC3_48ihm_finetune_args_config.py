...
def MIMIC3_48ihm_finetune_parse_args():
    parser = argparse.ArgumentParser(description="argparse")

    parser.add_argument("--exp_name", type=str, default="MIMIC3_48ihm_finetune_128_256_lowlowlr_euc_11_moegate_all_14_moegate_all_0.7_0714")
    ...
    parser.add_argument("--bert_lr", type=float, default=0.000002)  # 0.00001
    parser.add_argument("--modal_lr", type=str, default=0.00001)  # 0.00005
    parser.add_argument("--rag_lr", type=float, default=0.0001)  # 0.0002
    parser.add_argument("--other_lr", type=float, default=0.00005)  # 0.0002
    ...
    # stage: pretrain
    parser.add_argument("--pretrain_model", type=str, default="./save/pretrain/MIMIC3_48ihm_128_256_euc_11_0.7_moegate_all_14_0.7_moegate_all_0621_seed_42_batch_64_ts_model_UTDE_128_ns_model_mTand_25620250622/8.pth")
    # parser.add_argument("--pretrain_model", type=str,
    #                     default="./save/finetune/MIMIC3_48ihm_finetune_128_256_lowlowlr_euc_11_moegate_all_14_moegate_all_0.7_0624_seed_42_batch_3_ts_model_UTDE_128_ns_model_mTand_25620250624/2.pth")
    # parser.add_argument("--pretrain_model", type=str,
    #                     default="./save/finetune/MIMIC3_48ihm_finetune_full_128_256_lowlowlr_euc_11_moegate_all_14_moegate_all_0.7_0625_seed_42_batch_3_ts_model_UTDE_128_ns_model_mTand_25620250625/1.pth")
