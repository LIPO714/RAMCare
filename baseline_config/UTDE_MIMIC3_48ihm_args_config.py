...
def UTDE_MIMIC3_48ihm_parse_args():
    parser = argparse.ArgumentParser(description="argparse")

    parser.add_argument("--exp_name", type=str, default="UTDE_MIMIC3_48ihm_all_128_varLoss_output128_test_TS_modality_1006")
    ...
    # test & analysis
    parser.add_argument("--full_model", type=str, default="./save/48ihm/UTDE_MIMIC3_48ihm_all_128_varLoss_output128_0523_seed_42_epoch_50_batch_64_bioLongformer512_emb_dim_128/15.pth")
