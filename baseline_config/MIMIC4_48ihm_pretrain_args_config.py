...
def MIMIC4_ihm_pretrain_parse_args():
    parser = argparse.ArgumentParser(description="argparse")

    parser.add_argument("--exp_name", type=str, default="MIMIC4_ihm_128_384_dense_euc_12_0.7_moegate_all_add_no_freeze_200_0.0002_gru_(crossattn)_expert6_0704")
    ...
    parser.add_argument("--other_lr", type=float, default=0.0002)  # 0.0002
    ...
    parser.add_argument("--ns_pretrain_model", type=str, default="./save/48ihm/TextModel_MIMIC4_48ihm_dim384_all_0627_seed_42_epoch_50_batch_16_bioLongformer512_emb_dim_384/4.pth")
    # parser.add_argument("--ns_pretrain_model", type=str, default="./save/48ihm/TextModel_MIMIC4_48ihm_dim256_all_0626_seed_42_epoch_50_batch_16_bioLongformer512_emb_dim_256/4.pth")
    ...
    parser.add_argument("--ts_pretrain_model", type=str, default="./save/48ihm/UTDE_MIMIC4_ihm_all_128_varLoss_output128_0626_seed_42_epoch_50_batch_64_bioLongformer512_emb_dim_128/20.pth")
    ...
    # model RAG: TS -> NS
    # parser.add_argument("--ts2ns_rag", type=str, default="./data/MIMIC4/analysis/128_384/rag_128_384_co-kmeans_")
    parser.add_argument("--ts2ns_rag", type=str, default="./data/MIMIC4/analysis/128_384_dense/rag_128_384_co-kmeans_")
    # parser.add_argument("--ts2ns_rag", type=str, default="./data/MIMIC4/analysis/128_256_dense/rag_128_256_co-kmeans_")
    ...
    parser.add_argument("--ts_expert_num", type=int, default=6)
    parser.add_argument("--ts_rag_freeze", type=bool, default=False)

    parser.add_argument("--dropout", type=float, default=0.1)

    # classifier
    parser.add_argument("--classifier_type", type=str, default="crossattn", choices=['mlp', 'crossattn', 'res+mlp', 'mlp_128', 'res+mlp_128'])
    parser.add_argument("--classifier_nhead", type=int, default=4)
    parser.add_argument("--classifier_layers", type=int, default=1)  # TODO: 2
    parser.add_argument("--classifier_update_epoch", type=int, default=3)

    # loss
    parser.add_argument("--lambda_ts2ns", type=float, default=200.0)  # TODO:
