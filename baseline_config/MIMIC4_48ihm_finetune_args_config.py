...
def MIMIC4_ihm_finetune_parse_args():
    parser = argparse.ArgumentParser(description="argparse")

    parser.add_argument("--exp_name", type=str, default="MIMIC4_ihm_finetune_full_lr_128_384_dense_euc_12_0.7_moegate_all_(res+mlp)_0708")
    parser.add_argument("--stage", type=str, default="finetune", choices=['pretrain', 'finetune'])
    parser.add_argument("--data_percent", type=str, default="full", choices=['all', 'full'])
    ...
    parser.add_argument("--bert_lr", type=float, default=0.0000002)  # 0.00001  # 0.0000002  # 0.000001
    parser.add_argument("--modal_lr", type=str, default=0.000005)  # 0.00005  # 0.000005  # 0.00001
    parser.add_argument("--rag_lr", type=float, default=0.00002)  # 0.0002  # 0.00002  # 0.00005
    parser.add_argument("--other_lr", type=float, default=0.00001)  # 0.0002  # 0.00001  # 0.00003
    ...
    # stage: pretrain
    # parser.add_argument("--pretrain_model", type=str, default="./save/pretrain/MIMIC4_ihm_128_256_euc_10_0.7_moegate_all_200_0.0002_0628_seed_42_batch_128_ts_model_UTDE_128_ns_model_TextModel_38420250629/5.pth")
    # parser.add_argument("--pretrain_model", type=str, default="./save/pretrain/MIMIC4_ihm_128_256_euc_14_0.7_moegate_all_200_0.00008_mlp_0701_seed_42_batch_128_ts_model_UTDE_128_ns_model_TextModel_38420250702/5_0.pth")
    # parser.add_argument("--pretrain_model", type=str, default="./save/pretrain/MIMIC4_ihm_128_256_euc_15_0.7_moegate_all_200_0.0002_0629_seed_42_batch_128_ts_model_UTDE_128_ns_model_TextModel_38420250629/5.pth")
    parser.add_argument("--pretrain_model", type=str, default="./save/pretrain/MIMIC4_ihm_128_384_dense_euc_12_0.7_moegate_all_add_no_freeze_200_0.00008_gru_(res+mlp)_0703_seed_42_batch_128_ts_model_UTDE_128_ns_model_TextModel_38420250704/5_0.pth")
    ...
    # model: NS modality
    parser.add_argument("--ns_model", type=str, default="TextModel_384")
    parser.add_argument("--ns_pretrain_model", type=str, default="")
    parser.add_argument("--ns_embed_dim", type=int, default=384)
    ...
    parser.add_argument("--ts_pretrain_model", type=str, default="")
    ...
    parser.add_argument("--ts_cluster_num", type=int, default=12)
    ...
    parser.add_argument("--ts_expert_num", type=int, default=12)

    parser.add_argument("--dropout", type=float, default=0.1)

    # classifier
    parser.add_argument("--classifier_type", type=str, default="res+mlp", choices=['mlp', 'crossattn', 'res+mlp', 'mlp_128', 'res+mlp_128'])
