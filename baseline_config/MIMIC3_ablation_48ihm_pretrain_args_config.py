...
def MIMIC3_ablation_pretrain_parse_args():
    parser = argparse.ArgumentParser(description="argparse")

    parser.add_argument("--exp_name", type=str, default="MIMIC3_ablation_fusion_mult_1007")
    ...
    # TODO
    parser.add_argument("--wo_module", type=str, default="None", choices=['None', 'RAG', 'Loaded_RAG', 'MOE', 'MOE->MLP', 'co-keans'])
