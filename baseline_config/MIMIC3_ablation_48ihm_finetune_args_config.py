...
def MIMIC3_ablation_finetune_parse_args():
    parser = argparse.ArgumentParser(description="argparse")

    parser.add_argument("--exp_name", type=str, default="MIMIC3_ablation_finetune_fusion_mult_1007")
    parser.add_argument("--stage", type=str, default="finetune", choices=['pretrain', 'finetune'])
    parser.add_argument("--data_percent", type=str, default="all", choices=['all', 'full'])
    ...
    parser.add_argument("--bert_lr", type=float, default=0.000002)  # 0.000002
    parser.add_argument("--modal_lr", type=str, default=0.00001)  # 0.00001
    parser.add_argument("--rag_lr", type=float, default=0.0001)  # 0.0001
    parser.add_argument("--other_lr", type=float, default=0.00005)  # 0.00005
    # parser.add_argument("--bert_lr", type=float, default=0.00004)  # 0.000002
    # parser.add_argument("--modal_lr", type=str, default=0.0004)  # 0.00001
    # parser.add_argument("--rag_lr", type=float, default=0.0004)  # 0.0001
    # parser.add_argument("--other_lr", type=float, default=0.0004)  # 0.00005
    ...
    # stage: pretrain
    parser.add_argument("--pretrain_model", type=str, default="./save/pretrain/MIMIC3_ablation_fusion_mult_1007_seed_42_batch_64_ts_model_UTDE_128_ns_model_mTand_25620251007/8_0.pth")

    # test & analysis
    parser.add_argument("--full_model", type=str, default="./save/finetune/MIMIC3_48ihm_finetune_128_256_lowlowlr_euc_7_moe_all_14_moegate_all_0.7_0616_seed_42_batch_3_ts_model_UTDE_128_ns_model_mTand_25620250616/3.pth")
    ...
    parser.add_argument("--wo_module", type=str, default="None",
                        choices=['None', 'pretrain', 'RAG', 'Loaded_RAG', 'MOE', 'MOE->MLP', 'co-keans'])
    ...
    parser.add_argument("--ts_expert_num", type=int, default=11)
    ...
    parser.add_argument("--ns_topk_mask", type=int, default=3)
    ...
    parser.add_argument("--ns_expert_num", type=int, default=14)
    ...
    parser.add_argument("--ablation_fusion_type", type=str, default='mult', choices=['Interleaved', 'concat', 'tf', 'mag', 'mult'])
